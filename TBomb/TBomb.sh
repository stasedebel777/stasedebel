...
echo This Script Was Hacked By 16 yo motherfucker from lolzteam and yougame<and some others platforms>....
...
echo -e "\e[4;34m This Bomber Was hacked By https://vk.com/ld611 \e[0m"
echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"
echo -e "\e[1;32m           VK: https://vk.com/ld611"
echo " "
echo -e "\e[4;31m Please Read Instruction Carefully !!! \e[0m"
echo " "
echo "Press 1 To  Start SMS Bomber "
echo "Press 2 To  Start Broken Shit "
echo "Press 3 To  Update (Вы получите обычную версию) "
echo "Press 4 To  Protect Your Number (Вырезал от греха подальше)"
